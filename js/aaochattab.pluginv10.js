$(document).ready(function () {
  ...
  OCA.Aaochattab.Util = {
    ...
    attach: function(fileList) {
      ...
      //   */
      //   fileList.registerTabView(new OCA.Aaochattab.AaochatSidebarTabView('AaochatTabView', {order:-51}));
  ...
  setTimeout(function(){
    if( window.isLoadedAaochatPlugin==false){
      ...
      //OCA.Files.Sidebar.registerTab(OCA.Aaochattab.AaochatSidebarTabView);
    }
  },1000);
